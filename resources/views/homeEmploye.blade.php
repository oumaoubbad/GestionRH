...
<div class="right-box">
    <h1>
        ...
        <span>{{ Illuminate\Support\Facades\Auth::user()->prenom }}</span>
    ...
    <p class="p3"><span class="blue-text">{{ Illuminate\Support\Facades\Auth::user()->poste}}</span></p><br>
    ...
    <div class="col-div-4">
        <p class="p5">Sexe</p>
        <span class="span1">{{ Illuminate\Support\Facades\Auth::user()->sexe}}</span>
    </div>
    <div class="col-div-8">
        <p class="p5">Numero de Telephone</p>
        <span class="span1">{{ Illuminate\Support\Facades\Auth::user()->tel}}</span>
    </div>
    <div class="clearfix"></div>
    <br>
    <div class="col-div-4">
        <p class="p5">Date de naissance</p>
        <span class="span1">{{ Illuminate\Support\Facades\Auth::user()->date_naissance}}</span>
    </div>
    <div class="col-div-8">
        <p class="p5">Adresse</p>
        <span class="span1">{{ Illuminate\Support\Facades\Auth::user()->adresse}}</span>
    </div>
    <div class="clearfix"></div>
    <br>
    <div class="col-div-4">
        <p class="p5">CIN</p>
        <span class="span1">{{ Illuminate\Support\Facades\Auth::user()->numeroPieceIdentite}}</span>
    </div>
    <div class="col-div-8">
        <p class="p5">Adresse email</p>
        <span class="span1">{{ Illuminate\Support\Facades\Auth::user()->email}}</span>
    </div><br><br><br><br><br>
    ...
    <div class="col-div-4">
        <p class="p5">Poste</p>
        <span class="span1">{{ Illuminate\Support\Facades\Auth::user()->poste}}</span>
    </div>
    <div class="col-div-8">
        <p class="p5">Departement</p>
        <span class="span1"> {{ Illuminate\Support\Facades\Auth::user()->departement}}</span>
    </div>
    <div class="clearfix"></div>
    <br>
    <div class="col-div-4">
        <p class="p5">Type de contrat</p>
        <span class="span1">{{ Illuminate\Support\Facades\Auth::user()->type_contrat}}</span>
    </div>
    <div class="col-div-8">
        <p class="p5">Date d'embauche</p>
        <span class="span1">{{ Illuminate\Support\Facades\Auth::user()->dateDembauche}}</span>
    </div>
