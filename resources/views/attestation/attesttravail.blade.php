...
<div class="container">
  ...
  <div class="card-header">
   ...
   <div class="card-body">
    ...
    <h1><u>Attestation d'emploi</u></h1><br>
    </div>
    <p class="lead">
    ...
    <p class="lead">
    M. / Mme  <b> {{App\Models\User::findOrFail($attestation->user_id)->prenom}} {{App\Models\User::findOrFail($attestation->user_id)->name}}</b>,   demeurant<b>  {{App\Models\User::findOrFail($attestation->user_id)->adresse}}</b> est employé au sein de notre société en qualité de <b>{{App\Models\user::findOrFail($attestation->user_id)->poste}}</b>.
</p>

<p class="lead">
    La présente attestation lui est délivrée à sa demande pour servir et valoir ce que de droit.</p>
<p class="lead">
