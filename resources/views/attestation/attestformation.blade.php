...
<div class="container">
  ...
  <div class="card-header">
   ...
   <div class="card-body">
    ...
    <h1><u>Attestation de Formation</u></h1><br>
    </div>
    <p class="lead">
    ...
    <p class="lead">
    M. / Mme  <b> {{App\Models\User::findOrFail($attestation->user_id)->prenom}} {{App\Models\User::findOrFail($attestation->user_id)->name}}</b>, demeurant  <b>  {{App\Models\User::findOrFail($attestation->user_id)->adresse}}</b>,
</p>
<p class="lead">
    a suivi avec succès la formation sur le thème de .
    Au cours de la formation, <b> {{App\Models\User::findOrFail($attestation->user_id)->prenom}} {{App\Models\User::findOrFail($attestation->user_id)->name}}</b> a démontré une compréhension solide des sujets abordés et a accompli les tâches et les projets de manière satisfaisante.
</p>
...
<p class="lead">
    ...
    <p class="lead">
        ...
        </div></div></div> <div><a href="" class="btn btn-success" id="tiba3a" onclick="
