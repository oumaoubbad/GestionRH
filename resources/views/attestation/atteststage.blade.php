...
<div class="container">
  ...
  <div class="card-header">
   ...
   <div class="card-body">
    ...
    <h1><u>Attestation de stage</u></h1><br>
    </div>
    <p class="lead">
...
<p class="lead">
    A effectué un stage de 2 mois dans notre entreprise.
     Durant ce stage, il a occupé le poste de <b>{{App\Models\user::findOrFail($attestation->user_id)->poste}}</b>, et a réalisé les missions demandées.
</p>
