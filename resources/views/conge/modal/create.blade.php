...
<form action="{{ route('conge.store')}} " method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="modal fade text-left" id="CongeCreate" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">

                    <h4 class="modal-title">{{ __('demande de congé') }}</h4>
                ...
                {{-- <div class="mb-3">
                  ...
                  <div class="card-footer">
                    <a  href="/conge/indexE " type="submit" class="btn btn-outline-ddark"><b>Retour</b></a>
