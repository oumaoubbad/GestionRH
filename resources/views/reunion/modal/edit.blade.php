<form action="{{ route('reunion.update',$reunion->id)}}" method="post" enctype="multipart/form-data">
    {{-- {{ method_field('patch') }} --}}
    @csrf
    <div class="modal fade text-left" id="wahyata{{$reunion->id}}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">{{ __('Editer Cette Reunion') }}</h4>
                ...
                @endif
                         ...
                         {{-- c est un champs fl forme ismo token de type hidden  w kaykon fiha wahid value = "code"
                    ...
                    <input type="time"   name="heure_reunions" class="form-control"  value="{{$reunion->heure_reunions}}">
                      ...
                      <div class="card-footer">
                        ...
                        <button class="btn btn-success btn-blockkkk"><b>Valider</b></button>
