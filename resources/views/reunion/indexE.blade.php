        ...
        <div class="row align-users-center">
            <div class="col"><br>
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-user active">Réunion</li>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td  class="text-center">
                                 ...
                                 <a onclick="deleteAnnonce()"    href="{{route('reunion.deleteE',$reunion->id)}}" class="btn btn-outline-dark"><i class="fa fa-trash-alt"></i></i></a>
